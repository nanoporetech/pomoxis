...
## [v0.4.1] - 2026-04-09
### Fixed
- Fix CI for packaging and github upload

## [v0.4.0] - 2026-02-16
### Changed
- Support for python up to 3.14
- Bumped various dependency versions
- Moved to modern build process
### Removed
- Legacy utilities: `coverage_from_fastx`, `fastx_convert`, `long_fastx`, `qscores_from_summary`, `find_indels`, `intersect_assembly_errors`, `mini_assemble`
- Dependencies: `miniasm`, `racon`, `ncls`
- Programatic docs
### Fixed
- Make `stats_from_bam` tolerate pandas dtypes
- Fix `assess_homopolymers` counts aggregation
